...
@exposable
class NewProjectWebviewPageAPI extends AbstractFrontend {
    ...
    run(): void {
        ...
        info.innerText = 'Info in new-project.ts from dialog-demo';
...
document.addEventListener('DOMContentLoaded', async function() {
    PluginPage.create([NewProjectWebviewPageAPI]);
});
